...
docker run --rm \
        ...
        -v $VOLUME:/output/ \
        sw_segmentation python src/test_ensemble.py -i /input/ -d /tmp -o /output/images/automated-petct-lesion-segmentation/ --non_interactive -a --gpu_size small --eval_only --limit_gpu_memory_to 0.66 -ta --dataset AutoPET --dont_check_output_dir --no_log --val_sw_overlap 0.75 --no_data -x 0 --val_sw_batch_size 8 -t 5 --resume_from .
